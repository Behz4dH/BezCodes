  ...
  return (
    <section className="noise-overlay relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 40%, color-mix(in oklch, var(--accent) 6%, transparent), transparent)",
        }}
      />

      <div className="relative z-10 mx-auto max-w-6xl px-6 py-32 md:px-8">
        <div className="max-w-3xl">
          ...
          >
            I build software
            <br />
            <span className="text-gradient-accent">that thinks.</span>
          </motion.h1>
